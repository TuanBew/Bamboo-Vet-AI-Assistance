...
import type { DashboardFastData, DashboardFilters } from '@/lib/admin/services/dashboard'
...
export function DashboardClient({ initialData, initialFilters }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ================================================================= */}
      {/* Section 4: Nhan Vien — skeleton (slow data loaded client-side)  */}
      {/* ================================================================= */}
      ...
      {/* ================================================================= */}
      {/* Section 5: Khach Hang — skeleton (slow data loaded client-side) */}
      {/* ================================================================= */}
      ...
      {/* ================================================================= */}
      {/* Section 6: Top 10 — skeleton (slow data loaded client-side)     */}
      {/* ================================================================= */}
